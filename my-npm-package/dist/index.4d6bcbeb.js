...
const uplevel1Text = document.querySelector("#uplevel1");
...
const uplevel2Text = document.querySelector("#uplevel2");
...
const uplevel3Text = document.querySelector("#uplevel3");
...
const uplevel4Text = document.querySelector("#uplevel4");
...
const uplevel5Text = document.querySelector("#uplevel5");
...
function setAvailable() {
    if (cookieAccount < costs.at(0)) buttonUpgrade1.style.backgroundColor = "#E83F6F";
    else buttonUpgrade1.style.backgroundColor = "#7C7C7C";
    if (cookieAccount < costs.at(1)) buttonUpgrade2.style.backgroundColor = "#E83F6F";
    else buttonUpgrade2.style.backgroundColor = "#7C7C7C";
    if (cookieAccount < costs.at(2)) buttonUpgrade3.style.backgroundColor = "#E83F6F";
    else buttonUpgrade3.style.backgroundColor = "#7C7C7C";
    if (cookieAccount < costs.at(3)) buttonUpgrade4.style.backgroundColor = "#E83F6F";
    else buttonUpgrade4.style.backgroundColor = "#7C7C7C";
    if (cookieAccount < costs.at(4)) buttonUpgrade5.style.backgroundColor = "#E83F6F";
    else buttonUpgrade5.style.backgroundColor = "#7C7C7C";
}
function setPerSecValue() {
    let sum = 0.0;
    for(i = 0; i < 5; i++)sum += perSecValues[i];
    cookiePerSecValue = parseFloat(sum.toFixed(2));
}
function setPerClickValue() {
    let sum = 0.0;
    for(i = 0; i < 6; i++)sum += perClickValues[i];
...
buttonUpgrade1.addEventListener("click", ()=>{
    if (cookieAccount >= costs.at(0)) {
        ...
        uplevel1Text.innerText = upgradeArray[0];
...
buttonUpgrade2.addEventListener("click", ()=>{
    if (cookieAccount >= costs.at(1)) {
        ...
        uplevel2Text.innerText = upgradeArray[1];
...
buttonUpgrade3.addEventListener("click", ()=>{
    if (cookieAccount >= costs.at(2)) {
        upgradeArray[2] += 1;
        uplevel3Text.innerText = upgradeArray[2];
...
buttonUpgrade4.addEventListener("click", ()=>{
    if (cookieAccount >= costs.at(3)) {
        ...
        uplevel4Text.innerText = upgradeArray[3];
...
buttonUpgrade5.addEventListener("click", ()=>{
    if (cookieAccount >= costs.at(4)) {
        ...
        uplevel5Text.innerText = upgradeArray[4];
...
},{}]},["8TtF2","gLLPy"], "gLLPy", "parcelRequire3d95")
